	...
	public CalendarView() {
		...
		Appointment[] lTestAppointments = new Appointment[] {
				...
				, new Agenda.AppointmentImpl()
						...
						.withStartTime(new GregorianCalendar(lTodayLocalDate.getYear(),
								lTodayLocalDate.getMonthValue() - 1, lTodayLocalDate.getDayOfMonth(), 4, 00))

						.withEndTime(new GregorianCalendar(lTodayLocalDate.getYear(),
								lTodayLocalDate.getMonthValue() - 1, lTodayLocalDate.getDayOfMonth(), 5, 30))
				...
				// ZonedDateTime: there is no additional value in using
				// ZonedDateTime everywhere, so we just have one test
				// appointment
				...
				, new Agenda.AppointmentImplLocal()
						...
						.withEndLocalDateTime(lTomorrowLocalDate.atStartOfDay()) // at
																					// we
																					// going
																					// to
																					// do
